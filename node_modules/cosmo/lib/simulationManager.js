    ...
    exports.getSimulation(req.name,function(err,simulation)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if(simulation.dates[d].year == req.year)
                    {
                        if(simulation.dates[d].month == req.month)
                        {
                            if(simulation.dates[d].day == req.day)
                            {
                ...
                res("Simulation named " + req.name + " does not have date " + req.year + "y-" + req.month + "m-" + req.day + "d.");
            }
        }
    });
};
