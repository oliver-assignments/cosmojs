...
exports.getSimulationPackages = function(res) {
    ...
    for(var i = 0 ; i < simulations.length ; i++)
    {
        simulationPackages.push(
        {
            ...
            columns:simulations[i].columns,
            rows:simulations[i].rows
        });
    }
                ...
                for(var d = 0 ; d < requests[r].days ; d++)
                {
                    ...
                    if(simulations[s].day > 30)
                    {
                        ...
                        if(simulations[s].month > 12)
                        {
                            ...
                            //  Yearly logic
                            //  Monthly logic
                            simulate.onYear(simulations[s],function(err,nothing)
                            {
                                if(err)
                                {
                        ...
                        //  Monthly logic
                        simulate.onMonth(simulations[s],function(err,nothing)
                        {
                            if(err)
                            {
                    ...
                    //  Daily logic
                    simulate.simulateDay(simulations[s],function(err,nothing)
                    {
                        if(err)
                        {
