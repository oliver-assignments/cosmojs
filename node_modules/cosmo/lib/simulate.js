...
{
	CreateLandmass(req);
	//CreateOcean(req, req.area * 25); //  Each tile would get 25
    res(null);
};
...
function CreateLandmass(ctx)
{
    ...
    for (var c = 0; c < 3; c++)
    {
        ...
        for (var i = 0; i < 3; i++)
        {
            ...
            var blob_radius = utility.randomNumberBetween(0,3) + 1;
            ...
            for (var p = 0; p < blobResults.length; p++)
            {
                ...
                // { 
                    ctx.height[blobResults[p]] = 5 + utility.randomNumberBetween(0,500);
                    //continentMap[blobResults[p]] = 1;
                    console.log(ctx.height[blobResults[p]]);
                //}
            }
        }
    }
