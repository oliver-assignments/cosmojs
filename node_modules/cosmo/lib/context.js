...
exports.createContext = function(name, columns, rows, myTilt, myRotationDirection) 
{
    ...
    //  PLOT DATA  //
    ctx.nucium = new Array(ctx.plantArea);
    ctx.nutro = new Array(ctx.plantArea);
    ...
    ctx.GetPlantNeighbors = function(p,includeDiagonals)
    {
        ...
        var center = ctx.ConvertToPlantCoord(z);
    ...
    */
    ...
    {
        return ctx.dna[p].charCodeAt(0);
    };
    ctx.GetNutroConsumption = function(p)
    {
        return ctx.dna[p].charCodeAt(1);
    };
    ctx.GetNuciumMetabolism = function(p)
    {
        return ctx.dna[p].charCodeAt(2);
    };
    ctx.GetNuciumConsumption= function(p)
    {
        return ctx.dna[p].charCodeAt(3);
    };
    ctx.GetNutroEndowment = function(p)
    {
        return ctx.dna[p].charCodeAt(4);
    };
    ctx.GetNuciumEndowment = function(p)
    {
        return ctx.dna[p].charCodeAt(5);
    };
    return ctx;
};
